 ...
 */
namespace app\modules\agii\generators\controller;
...
class Generator extends \yii\gii\Generator {
	 ...
	 */
	public $baseClass = 'app\components\AController';
	/**
	 *
	...
	public function successMessage() {
		...
		$link = Html::a ( 'try it now', Yii::$app->getUrlManager ()->createUrl ( $route ), [ 
				'target' => '_blank' 
		] );
	...
	public function generate() {
		...
		$files [] = new CodeFile ( $this->getControllerFile (), $this->render ( 'controller.php' ) );
		
		foreach ( $this->getActionIDs () as $action ) {
			$files [] = new CodeFile ( $this->getViewFile ( $action ), $this->render ( 'view.php', [ 
					'action' => $action 
			] ) );
		}
