...
/**
 * agii module definition class
 */
class Agii extends \yii\base\Module implements BootstrapInterface
{
    /**
     * @inheritdoc
     */
    public $controllerNamespace = 'app\modules\agii\controllers';
    ...
    {
    	return [
    			'model' => ['class' => 'app\modules\agii\generators\model\Generator'],
    			'crud' => ['class' => 'app\modules\agii\generators\crud\Generator'],
    			'controller' => ['class' => 'app\modules\agii\generators\controller\Generator'],
    			'form' => ['class' => 'app\modules\agii\generators\form\Generator'],
    			'module' => ['class' => 'app\modules\agii\generators\module\Generator'],
    			'extension' => ['class' => 'app\modules\agii\generators\extension\Generator'],
    	];
    }
}
